...
{
    KAboutData about("simple", 0, ki18n("KCM_PlayBarShortcuts"), version, ki18n(description),
    ...
    KCM_PlayBarShortcuts *mainWindow = new KCM_PlayBarShortcuts;
    mainWindow->show();

    KComponentData kcd = PlayBarShortcutsFactory::componentData();
